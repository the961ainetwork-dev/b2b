...
export default function AdminPanel({ 
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans" id="admin-panel-canvas">
      ...
      <nav className="border-b border-slate-800 bg-slate-900/80 backdrop-blur sticky top-0 z-[110] px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between" id="admin-nav-bar">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xs font-mono font-bold uppercase tracking-widest text-amber-500">System Dashboard Portal</span>
              <span className="bg-slate-800 text-[9px] text-slate-400 font-mono font-medium px-1.5 py-0.5 rounded border border-slate-700">Root Accs</span>
            </div>
        ...
        <button 
          onClick={onClose}
          className="bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-slate-600 text-slate-100 font-bold text-xs px-4 py-2 rounded-xl transition cursor-pointer select-none"
        ...
        {saveBanner && (
          <div className="bg-emerald-600 text-white rounded-2xl p-4 shadow-2xl border border-emerald-500 flex items-start gap-3 pointer-events-auto animate-fade-in">
            ...
            <div className="space-y-0.5">
              <span className="text-xs font-mono font-bold block uppercase tracking-wide">Live Propagation Success</span>
              <p className="text-[11px] opacity-90 leading-tight">{saveBanner}</p>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12" id="admin-main-grid">
        ...
        {/* Intro Alert */}
        <div className="bg-slate-900 border border-slate-800 rounded-2.5xl rounded-3xl p-6 mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden" id="admin-overview-jumbotron">
          <div className="absolute inset-0 bg-grid-pattern opacity-[0.01] pointer-events-none" />
          <div className="space-y-2 max-w-3xl">
            <div className="flex items-center gap-1 text-amber-500 font-mono text-[10px] font-extrabold uppercase">
          ...
          <div className="bg-slate-950 border border-slate-800 p-4 rounded-2xl flex items-center gap-3 shrink-0 self-start md:self-center">
            ...
            <div className="space-y-0.5">
              <span className="text-[10px] text-slate-400 font-mono uppercase block">Active Sections</span>
          ...
          <div className="lg:col-span-3 space-y-3.5">
            ...
            <div className="flex flex-col gap-1.5">
              <button
                ...
                className={`w-full text-left p-3.5 rounded-2.5xl rounded-2xl border transition-all duration-150 cursor-pointer flex items-center gap-3.5 ${
                  activeTab === 'sections' 
              ...
              >
                ...
                <div className="text-left font-sans">
                  <span className="block text-xs font-bold leading-none">Homepage Sections</span>
                  <span className={`block text-[9px] mt-1 font-mono ${activeTab === 'sections' ? 'text-slate-900' : 'text-slate-500'}`}>
              ...
              >
                ...
                <div className="text-left font-sans">
                  <span className="block text-xs font-bold leading-none">Published Stories</span>
                  <span className={`block text-[9px] mt-1 font-mono ${activeTab === 'stories' ? 'text-slate-900' : 'text-slate-500'}`}>
              ...
              >
                ...
                <div className="text-left font-sans">
                  <span className="block text-xs font-bold leading-none">Site Settings</span>
                  <span className={`block text-[9px] mt-1 font-mono ${activeTab === 'branding' ? 'text-slate-900' : 'text-slate-500'}`}>
            ...
            {/* Quick Helper card */}
            <div className="bg-slate-900 border border-slate-800 uppercase p-4 rounded-2xl space-y-2 mt-4 text-[10px] text-slate-400 font-mono">
              ...
              <div className="space-y-8 animate-fade-in" id="admin-tab-sections">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                    ...
                    <span className="text-xs bg-slate-800 px-3 py-1 rounded text-slate-400 font-mono font-bold">
                          ...
                          <div className="flex items-start gap-3.5 min-w-0 flex-1">
                            ...
                            <div className="space-y-1 min-w-0 flex-1">
                              <div className="flex items-center gap-1.5 flex-wrap">
                                <span className="font-mono text-[9px] bg-slate-800 text-slate-400 px-1.5 py-0.5 rounded uppercase tracking-wider font-extrabold">
                                  ID: {section.id}
                                </span>
                                ...
                                {!section.isVisible && (
                                  <span className="text-[9px] bg-red-950/50 border border-red-900/50 text-red-400 px-1.5 py-0.2 rounded font-mono font-bold">
                                    HIDDEN
                                  </span>
                                )}
                              </div>
                              <div className="space-y-2 mt-2">
                                <input 
                                  ...
                                  className="w-full text-xs font-semibold bg-slate-900 border border-slate-800 focus:border-amber-500 focus:outline-none rounded px-2.5 py-1 text-white placeholder-slate-500 font-sans"
                                ...
                                <input 
                                  ...
                                  className="w-full text-[11px] bg-slate-900 border border-slate-800 focus:border-amber-500 focus:outline-none rounded px-2.5 py-1 text-slate-400 placeholder-slate-500 font-sans"
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-base font-bold text-white uppercase tracking-wider font-mono flex items-center gap-1.5">
                  ...
                  <form onSubmit={handleAddCustomSection} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5 col-span-1">
                      <label className="text-[10px] font-bold text-slate-550 text-slate-400 uppercase tracking-wider font-mono block">
                      ...
                      <input 
                        ...
                        className="w-full text-xs bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 focus:border-amber-500 focus:outline-none text-white font-mono"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5 col-span-1">
                      ...
                      <input 
                        ...
                        className="w-full text-xs bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 focus:border-amber-500 focus:outline-none text-white"
                      />
                    </div>
                    ...
                    <div className="md:col-span-2 pt-2 flex justify-end">
                      <button
                        type="submit"
                        className="bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold text-xs px-5 py-3 rounded-2xl transition duration-150 cursor-pointer shadow-lg shadow-amber-500/10 flex items-center gap-1.5"
                      >
                      ...
                      >
                        <div className="space-y-2">
                          <div className="flex items-start justify-between gap-3">
                            ...
                            <div className="flex items-center gap-1 bg-slate-900 px-2 py-0.5 rounded text-xs font-bold text-amber-500 border border-slate-800">
                              ★ <span>{story.rating}</span>
                            </div>
                          </div>

                          <p className="text-xs text-slate-400 italic leading-relaxed font-sans pt-1">
                            "{story.quote}"
                          </p>
                        </div>
                        ...
                        <div className="pt-3 border-t border-slate-850 flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="text-[10px] text-red-400 hover:text-red-300 font-bold flex items-center gap-1 transition cursor-pointer"
                          >
                  ...
                  <form onSubmit={handleAddStory} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5 md:col-span-2 col-span-1">
                      ...
                      <textarea
                        ...
                        className="w-full text-xs bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 focus:border-amber-500 focus:outline-none text-white font-sans"
                      />
                    </div>
              ...
              <div className="space-y-8 animate-fade-in" id="admin-tab-branding">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-1.5">
                      ...
                      <div className="flex gap-2">
                        <input 
                          ...
                          className="flex-1 text-xs bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 focus:border-amber-500 focus:outline-none text-white font-bold"
                          placeholder="e.g. Verified Lead Indexer"
                        />
                        <button
                          type="button"
                          onClick={() => triggerBanner('Branding title applied live.')}
                          className="bg-slate-800 hover:bg-slate-750 text-white font-mono text-xs px-4 rounded-xl border border-slate-700 font-bold"
                        >
                          Verify Update
                        </button>
                      </div>
                    ...
                    {/* Metadata summary */}
                    <div className="bg-slate-950 border border-slate-850 p-4.5 rounded-2xl space-y-2 text-xs">
                      <span className="font-mono text-[9px] font-extrabold text-amber-500 uppercase block tracking-wider">
